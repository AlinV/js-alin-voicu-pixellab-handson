...
console.warn(
  `Folosind destructurarea, salveaza primul si ultimul skill in
   variabile numite skill1 si skill3, apoi folosind aceaste variabile,
...
console.warn(`
  ...
  pentru a obtine obiectul de pe indexul 1 apoi
  destructureaza obiectul obtinut in variabilele friend2Name,
  friend2Surname si friend2Age astfel incat sa le poti
  folosi in propozitia: Ma numesc Steven Stevenson si am 31 de ani.
`);
...
console.warn(
  `Destructureaza obiectul person pentru a obtine o variabila hasPet
   si in functie de aceasta afiseaza propozitia: “Persoana are/nu are
   animale”`,
);
...
console.warn(`Destructureaza arrayul friends si obiectele de pe indexul
 0 (friend1) si 2 (friend3), astfel incat sa poti afisa propozitiile:
