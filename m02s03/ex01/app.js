class Car {
  ...
  displaySpeedInDom() {
    const instanceMessage = document.querySelector('.' + this.make);
...
console.warn(`
  Optimizeaza codul din exercitiu astfel incat sa folosesti chaining
  pentru a accelera
  Converteste si metoda decelerate la metoda chainable.
  Adu instanta masinii la viteza 55 apoi redu la 52, folosind chaining.
  Afiseaza in DOM (prin orice metoda) viteza instantei dupa lantul de
  metode.
`);
